...
public class SecurityConfig {
    ...
    private static final String ROLE_GENRES = "CATALOGO_GENERES";
    ...
    public SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
        return http
                .csrf(csrf -> {
                    csrf.disable(); // cross site desabilitado para o frontend.
                })
...
//    @Bean
//    public SecurityFilterChain securityFilterChainA(final HttpSecurity http) throws Exception {
//        http
//                .csrf().disable()
